...
## Game Classes
  * **FindTheThimble.java**: Contains the internal logic for the "Find the Thimble" game.
  * **CoinFlip.java**: Contains the internal logic for the "Coin Flip" game.
  * **GuessTheNumber.java**: Contains the internal logic for the "Guess the Number" game.
  * **EvenOdd.java**: Contains the internal logic for the "Even and Odd" game.
